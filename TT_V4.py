...
def countdown(time_sec):
    for remaining_time in range(time_sec, -1, -1):
        colors = [
            "\033[1;37m\033[1;36m\033[1;35m\033[1;32m\033[1;31m \033[1;34m\033[1;33m\033[1;36m\033[1;33m 𝓑𝓞𝓢𝓢 \033[1;36m \033[1;31m\033[1;32m",
            "\033[1;34m\033[1;31m\033[1;37m\033[1;36m\033[1;32m \033[1;35m\033[1;37m\033[1;33m\033[1;33m 𝓑𝓞𝓢𝓢 \033[1;34m \033[1;31m\033[1;32m",
            "\033[1;31m\033[1;37m\033[1;36m\033[1;33m\033[1;35m \033[1;32m\033[1;34m\033[1;35m\033[1;33m 𝓑𝓞𝓢𝓢 \033[1;33m \033[1;31m\033[1;32m",
            "\033[1;32m\033[1;33m\033[1;34m\033[1;35m\033[1;36m \033[1;37m\033[1;36m\033[1;31m\033[1;33m 𝓑𝓞𝓢𝓢 \033[1;31m \033[1;31m\033[1;32m",
            "\033[1;37m\033[1;34m\033[1;35m\033[1;36m\033[1;32m \033[1;33m\033[1;31m\033[1;37m\033[1;33m 𝓑𝓞𝓢𝓢✔️\033[1;37m \033[1;31m\033[1;32m",
            "\033[1;34m\033[1;33m\033[1;37m\033[1;35m\033[1;31m \033[1;36m\033[1;36m\033[1;32m\033[1;33m 𝓑𝓞𝓢𝓢✔️\033[1;36m \033[1;31m\033[1;32m",
            "\033[1;36m\033[1;35m\033[1;31m\033[1;34m\033[1;37m \033[1;35m\033[1;32m\033[1;36m\033[1;33m 𝓑𝓞𝓢𝓢✔️\033[1;33m \033[1;31m\033[1;32m",
        ]
        for color in colors:
    ...
    print("\r                          \r", end="") 
    console.print("[bold yellow]𝓑𝓞𝓢𝓢[/bold yellow][bold magenta]|Đᴀɴɢ ᴛʀả ʟươɴɢ...", end="\r")
...
def TIKTOKINFO():  
    ...
    for data in checkurl1_2['data']:
        ...
        print(f'\033[1;36m[{i}] \033[1;36m✈️ \033[1;97mTên┊\033[1;32m\033[1;93m {usernametk} \033[1;97m|\033[1;32m🍀 \033[1;93m {STATUS[-1]}')
        i += 1

    console.print("[bold magenta]═══════════════════════════════[/bold magenta][bold yellow]═════════════════════════════[/bold yellow]")
    choose = int(Prompt.ask("[bold yellow]𝓑𝓞𝓢𝓢[/bold yellow][bold magenta]|ɴʜậᴘ ᴠị ᴛʀí ᴛêɴ: "))
    os.system('cls' if os.name== 'nt' else 'clear')
    ...
    if choose >= 1 and choose <= len(user_tiktok1):
        ...
        job_count = int(Prompt.ask("[bold yellow]𝓑𝓞𝓢𝓢[/bold yellow][bold magenta]|ɴʜậᴘ số ʟượɴɢ: " ))
        DELAY = int(Prompt.ask("[bold yellow]𝓑𝓞𝓢𝓢[/bold yellow][bold magenta]|ɴʜậᴘ ᴅᴇʟᴀʏ: " ))
        
        console.print("[bold magenta]═══════════════════════════════[/bold magenta][bold yellow]═════════════════════════════[/bold yellow]")
        i = 0

        # Danh sách tổ hợp màu cố định (mỗi tổ hợp có 5 màu, không trùng hoàn toàn)
        color_combinations = [
            [0, 1, 2, 3, 4],  # Đỏ, Vàng, Xanh lá, Xanh dương nhạt, Xanh dương đậm
            [1, 2, 3, 4, 5],  # Vàng, Xanh lá, Xanh dương nhạt, Xanh dương đậm, Tím
            [2, 3, 4, 5, 6],  # Xanh lá, Xanh dương nhạt, Xanh dương đậm, Tím, Tím nhạt
            [3, 4, 5, 6, 0],  # Xanh dương nhạt, Xanh dương đậm, Tím, Tím nhạt, Đỏ
            [4, 5, 6, 0, 1],  # Xanh dương đậm, Tím, Tím nhạt, Đỏ, Vàng
            [5, 6, 0, 1, 2],  # Tím, Tím nhạt, Đỏ, Vàng, Xanh lá
            [6, 0, 1, 2, 3],  # Tím nhạt, Đỏ, Vàng, Xanh lá, Xanh dương nhạt
        ]
        combination_index = 0  # Theo dõi tổ hợp hiện tại

        while True:
            if i >= job_count:  # job_count là số lượng công việc người dùng nhập
                break
            ...
            if checkurl2['status'] == 200:
                ...
                # Định nghĩa 7 màu cầu vồng
                rainbow_colors = [
                    "\033[1;31m",  # Đỏ
                    "\033[1;33m",  # Vàng
                    "\033[1;32m",  # Xanh lá
                    "\033[1;36m",  # Xanh dương nhạt
                    "\033[1;34m",  # Xanh dương đậm
                    "\033[1;35m",  # Tím
                    "\033[1;95m"   # Tím nhạt
                ]
                ...
                if checkurl3['status'] == 400:
                    ...
                    if checkurl3['status'] == 200:
                        ...
                        # Sử dụng tổ hợp màu từ danh sách
                        current_colors = color_combinations[combination_index]
                        chuoi_parts = [
                            f"| {dem} | ",
                            f"{h}:{m}:{s} | ",
                            f"{type} | ",
                        ...
                        chuoi = "".join([rainbow_colors[current_colors[i]] + part for i, part in enumerate(chuoi_parts)]) + reset
                        print(chuoi)
                        combination_index = (combination_index + 1) % len(color_combinations)  # Chuyển sang tổ hợp tiếp theo
...
if checkfile == False:
    AUTHUR = console.input("[[bold yellow]𝓑𝓞𝓢𝓢[/bold yellow]|[bold magenta]Nhập AUT[/bold magenta]][bold green]#   ")
...
if checkurl1['status']== 200 :
        console.print('[bold red]DANG NHAP THANH CONG[/bold red]')
        time.sleep(3)
        os.system('cls' if os.name== 'nt' else 'clear')
        LIST()
        ...
        print(Fore.GREEN+'\033[1;32mTổng Tiền : '+Fore.YELLOW+str(coin))
        console.print("[bold magenta]═══════════════════════════════[/bold magenta][bold yellow]═════════════════════════════[/bold yellow]")
        console.print("[bold magenta][bold green]ɴʜậᴘ 【𝟷】: [bold cyan]Để ᴛɪếᴘ ᴛụᴄ  ")
        console.print("[bold magenta][bold green]ɴʜậᴘ 【2】: [bold cyan]Để xóᴀ ᴀᴜᴛ  ")
        choose = int(Prompt.ask("[[bold yellow]𝓑𝓞𝓢𝓢[/bold yellow]|[bold magenta]@daocaonguyen[/bold magenta]][bold green]#   "))
        if choose == 1:
                os.system('cls' if os.name== 'nt' else 'clear')
                LIST()
                ses.headers.update(headers)
